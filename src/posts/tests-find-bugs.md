...
_yoast_wpseo_linkdex:
    - '73'
---
Dr. Mauricio Aniche explains how developers can write tests that find bugs. Writing effective test cases that bring confidence is not that easy. Many developers are familiar with testing frameworks and regularly write automated software tests. Yet, often they don’t test systematically. That’s why Mauricio writes a book called “Effective Software Testing” which shows practical approaches to systematically test software. You can win a digital copy of the Effective Software Testing book, when you like and retweet this episode’s link, [which you can find here](https://twitter.com/se_unlocked/status/1483359270997573633?s=20).
...
- and about the importance of maintainable test code.
 ...
 ![Mauricio Aniche](../uploads/2022/01/Mauricio_Aniche.jpg)

Today’s episode is sponsored by [<u>Codiga</u>](https://www.codiga.io/?utm_source=podcast&utm_medium=social&utm_campaign=se_unlocked), a smart coding assistant and automated code review platform. [<u>Try Codiga for FREE</u>](https://www.codiga.io/?utm_source=podcast&utm_medium=social&utm_campaign=se_unlocked)!

Links:

- For a chance to win the “Effective Software Testing” book, [like and retweet today’s episode](https://twitter.com/se_unlocked/status/1483359270997573633?s=20)
- [Effective Software Testing – The Book](https://www.effective-software-testing.com/)
- [Flaky Tests blog post by Mauricio](https://www.effective-software-testing.com/can-we-get-fully-rid-of-flaky-tests)
- [Mauricio’s newsletter](https://effectivesoftwaretesting.substack.com/)
- [The art of testing less – How Microsoft copes with flaky tests](https://www.michaelagreiler.com/wp-content/uploads/2019/02/The-Art-of-Testing-Less-without-Sacrificing-Quality.pdf)
- [Test Codiga, your coding assistant, for free today](https://www.codiga.io/?utm_source=podcast&utm_medium=social&utm_campaign=se_unlocked)
...
So you asked, what do you have to do for that? Right. Well, there’s the chance to win this book. If you like and retweet this episode’s, tweet, I will put it in the show notes, or you can find it on se\_underscore unlocked on Twitter. For an extra chance to win the book, you can add a comment on your personal best testing practice. But now let’s welcome Mauricio. Mauricio, welcome to the show.
